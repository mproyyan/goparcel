...
db.permissions.insertMany([
    {
        "_id" : ObjectId("67b54b11ba1542ee89a0f140"),
        "user_management" : {
    ...
    {
        "_id" : ObjectId("67b54b11ba1542ee89a0f141"),
        "user_management" : {
            "get_user_location" : true,
            "get_user" : true
        },
    ...
    {
        "_id" : ObjectId("67b54b11ba1542ee89a0f142"),
        "user_management" : {
            "get_user_location" : true,
            "get_user" : true
        },
        "shipment" : {
            "create_shipment" : false,
            "get_unrouted_shipments" : false,
            "get_routed_shipments" : false,
            "get_incoming_shipments" : false,
            "scan_arriving_shipments" : false,
            "ship_package" : false,
            "add_itinerary_history" : false,
            "send_package" : false,
            "complete_shipment" : false
    ...
    {
        "_id" : ObjectId("67b54b11ba1542ee89a0f143"),
        "user_management" : {
            "get_user_location" : true,
            "get_user" : true
        },
